...
import com.harsh.cermati.db.UserDatabase
import com.harsh.cermati.ui.ViewModelFactory
...
object Injection {
    ...
    /**
     * Creates an instance of [UserLocalCache] based on the database DAO.
     */
    ...
    private fun provideGithubRepository(context: Context): GithubRepository {
        return GithubRepository(WebService.create(), provideCache(context))
    }
